...
from dataset_3d_v2 import BraTSWindowDataset, discover_volumes, split_volume_ids
...
class Config:
    ...
    runs_dir: str = "runs_3d_v2"
    best_dir: str = "best_model_3d_v2"
...
def main() -> None:
    ...
    run_dir = Path(CFG.runs_dir) / f"run_3d_v2_{timestamp}"
    ...
    history_path = run_dir / "history_3d_v2.csv"
        ...
        with history_path.open("a", newline="", encoding="utf-8") as file:
            csv.writer(file).writerow(
                [
                    ...
                    val_metrics["Recall / Sensitivity"],
                    learning_rate,
                    seconds,
                ]
            )
